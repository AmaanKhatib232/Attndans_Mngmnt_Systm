...
<div class="row">
    ...
    <div class="form-group">
      ...
      <label for="input1" class="col-sm-3 control-label" style="color: white">User Role:</label>
      <div class="col-sm-7">
      ...
      <input type="submit" style="border-radius:0%" class="btn btn-success col-md-3 col-md-offset-7" value="Signup" name="signup"/>
    </form>
  ...
  <br>
    <p><strong style="color: white">Already have an account? <a href="index.php">Login</a> here.</strong></p>
